        ...
        <div class="row stat-cards">
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num">72 166</p>
                <p class="stat-cards-info__title">Total visits</p>
                <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit success">
                    <i data-feather="trending-up" aria-hidden="true"></i>5.02%
                  </span>
                  Last month
                </p>
              </div>
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num">11 572</p>
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num">10 221</p>
                <p class="stat-cards-info__title">User active</p>
                <p class="stat-cards-info__progress">
          ...
          <div class="col-md-6 col-xl-3">
            <article class="stat-cards-item">
              ...
              <div class="stat-cards-info">
                <p class="stat-cards-info__num">19 586</p>
                <p class="stat-cards-info__title">Total users</p>
                <p class="stat-cards-info__progress">
                  <span class="stat-cards-info__profit warning">
                    <i data-feather="trending-up" aria-hidden="true"></i>0.46%
                  </span>
                  Last month
                </p>
              </div>
                    ...
                    <td>
                      <label class="users-table__checkbox">
                        ...
                        <div class="categories-table-img">
                          <picture><source srcset="../bootstrap/img/categories/ipx.JPEG" type="image/JPEG"><img src="../bootstrap/img/categories/ipx.jpeg"></picture>
                        </div>
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <label class="users-table__checkbox">
                        <input type="checkbox" class="check">
                        <div class="categories-table-img">
                        <picture><source srcset="../bootstrap/img/categories/smw9.PNG" type="image/PNG"><img src="../bootstrap/img/categories/smw9.png"></picture>
                        </div>
                      </label>
                    </td>
                    <td>
                  ...
                  <tr>
                    <td>
                      <label class="users-table__checkbox">
                        <input type="checkbox" class="check">
                        <div class="categories-table-img">
                        <picture><source srcset="../bootstrap/img/categories/macpro.JPG" type="image/JPG"><img src="../bootstrap/img/categories/macpro.jpg"></picture>
                        </div>
                      </label>
                    </td>
                    <td>
          ...
          <div class="col-lg-3">
            ...
            <article class="white-block">
              <div class="top-cat-title">
                ...
                <p>4 Categories, 1400 Posts</p>
              </div>
              <ul class="top-cat-list">
                <li>
                  <a href="##">
                  <div class="top-cat-list__title">
                      Laptop<span>8.2k</span>
                    </div>
                    <div class="top-cat-list__subtitle">
                      Asus TUF Laptop <span class="purple">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    ...
                    <div class="top-cat-list__subtitle">
                      Lenovo Legion 5<span class="blue">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    ...
                    <div class="top-cat-list__subtitle">
                      MSI Gaming Laptop<span class="danger">+472</span>
                    </div>
                  </a>
                </li>
                <li>
                  <a href="##">
                    ...
                    <div class="top-cat-list__subtitle">
                      Razer Glade 15 Laptop<span class="success">+472</span>
                    </div>
                  </a>
                </li>
              </ul>
